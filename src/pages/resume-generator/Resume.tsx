            ...
            <AnimatePresence mode="popLayout">
              {resumes.map((resume, index) => (
                ...
                >
                  ...
                  <div className="absolute bottom-4 right-4 flex items-center gap-1 pointer-events-auto" style={{ zIndex: 10 }}>
              ...
              <div className="flex items-center gap-6 w-full">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-500 mt-1 leading-relaxed max-w-[280px]">
                    Build your professional profile in minutes. Choose from multiple methods to get started.
                  </p>
                </div>
            ...
            >
              <div className="p-6 text-center">
                ...
                <p className="text-sm text-gray-500 leading-relaxed">
                  This action cannot be undone. All your progress on this resume will be permanently removed.
                </p>
              </div>
