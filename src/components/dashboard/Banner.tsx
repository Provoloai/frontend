    ...
    return (
        <div className="relative flex items-center gap-x-6 overflow-hidden px-6 py-6 rounded-xl border bg-[#001633]/5 border-[#001633]/20">
            ...
            <div className=" w-full items-center gap-y-4">
                <span>
                    <strong className="font-heading text-base">We're Live</strong><br />
            ...
            <div className=" flex-1 justify-end relative">
                <BellRing size={90} opacity={0.2} className='rotate-12 text-[#001633] absolute right-2 top-0.5'/>
                <BellRing size={90} opacity={0.5} className='rotate-12 text-[#001633]'/>
            </div>
