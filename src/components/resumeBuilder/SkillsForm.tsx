...
interface SkillWithId extends Skill {
  id: string; // The Skill interface already has id, but this ensures it
}
...
export const SkillsForm: React.FC<SkillsFormProps> = ({ watch, setValue }) => {
  const skills = (watch("content.skills") || []) as SkillWithId[];
  ...
  const addSkill = (name: string): void => {
    ...
    setValue("content.skills", [...skills, newSkill]);
    setSearchQuery("");
  };
    ...
    >
      <div>
        ...
        <p className="text-xs text-gray-600 mt-1">
          Select up to 10 skills that highlight your professional expertise
        </p>
      </div>
      ...
      <div className="space-y-4">
        <div className="relative">
          ...
          <input
            ...
            placeholder={
              skills.length >= 10
                ? "Limit of 10 skills reached"
                : "Search or add custom skill..."
            }
      ...
      {skills.length === 0 && searchQuery === "" && (
        ...
        >
          ...
          <p className="text-xs text-gray-500 mt-1">
            Or search to add your own special expertise
          </p>
        </motion.div>
      )}
        ...
        <div className="space-y-2 px-1">
          <div className="flex items-start gap-3">
            ...
            <p className="text-[11px] text-blue-800 leading-relaxed">
              Include both **technical** and **soft skills** to show a
          ...
          <div className="flex items-start gap-3">
            <div className="w-1 h-1 rounded-full bg-blue-400 mt-1.5 flex-shrink-0"></div>
            <p className="text-[11px] text-blue-800 leading-relaxed">
              List specific tools and frameworks you've mastered to show
              **practical depth**
            </p>
          </div>
        </div>
