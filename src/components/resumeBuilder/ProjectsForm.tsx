...
import { Trash2, FolderGit2, Calendar, Link as LinkIcon, ChevronDown, ChevronUp, GripVertical, Lightbulb } from "lucide-react";
      ...
      >
        ...
        >
          <div className="flex items-center gap-3 pr-8">
            <div className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 ${isExpanded ? "bg-green-100" : "bg-gray-200"
              }`}>
              <FolderGit2 className={`w-4 h-4 ${isExpanded ? "text-green-600" : "text-gray-500"}`} />
            </div>
                ...
                <Controller
                  ...
                  render={({ field }: { field: any }) => (
                    <TextInputField
                      ...
                      iconStart={<FolderGit2 className="w-4 h-4 text-gray-400" />}
                    />
                  )}
                />
                  ...
                  render={({ field }: { field: any }) => (
                    <TextInputField
                      ...
                      onChange={(e) => {
                        ...
                        field.onChange(value ? value.split(",").map((t: string) => t.trim()) : []);
                      }}
...
export const ProjectsForm: React.FC<ProjectsFormProps> = ({ control, watch, setValue }) => {
  ...
  const removeProject = (id: string) => {
    setValue('projects', projects.filter((project: any) => project.id !== id));
    if (expandedId === id) setExpandedId(null);
  };

  const handleReorder = (newOrder: any[]) => {
    setValue('projects', newOrder, { shouldDirty: true, shouldValidate: true });
  };
    ...
    >
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-xs text-gray-600 mt-1">Showcase your portfolio and side projects</p>
        </div>
      ...
      {projects.length === 0 && (
        ...
        >
          ...
          <p className="text-xs text-gray-500">Click "Add Project" to get started</p>
        </motion.div>
      )}
        ...
        <div className="space-y-2 px-1">
          <div className="flex items-start gap-3">
            ...
            <p className="text-[11px] text-blue-800 leading-relaxed">
              Include **live links** or GitHub repositories to showcase your work
            </p>
          </div>
          <div className="flex items-start gap-3">
            <div className="w-1 h-1 rounded-full bg-blue-400 mt-1.5 flex-shrink-0"></div>
            <p className="text-[11px] text-blue-800 leading-relaxed">
              Highlight **measurable outcomes** (e.g., "increased performance by 40%")
            </p>
          </div>
          <div className="flex items-start gap-3">
            <div className="w-1 h-1 rounded-full bg-blue-400 mt-1.5 flex-shrink-0"></div>
